...
import { UserDatasetContributorEditor } from "./dashboard/component/user/user-dataset/user-dataset-explorer/user-dataset-contributor-editor/user-dataset-contributor-editor";
import { UserDatasetFunderEditor } from "./dashboard/component/user/user-dataset/user-dataset-explorer/user-dataset-funder-editor/user-dataset-funder-editor";
import { UserDatasetSpecimenEditor } from "./dashboard/component/user/user-dataset/user-dataset-explorer/user-dataset-specimen-editor/user-dataset-specimen-editor";
...
@NgModule({
  declarations: [
    ...
    UserDatasetFunderEditor,
    UserDatasetSpecimenEditor,
