...
public class Keys {
    ...
    public static final ForeignKey<MetadataContributorRecord, DatasetRecord> METADATA_CONTRIBUTOR__METADATA_CONTRIBUTOR_METADATA_ID_FKEY = Internal.createForeignKey(MetadataContributor.METADATA_CONTRIBUTOR, DSL.name("metadata_contributor_metadata_id_fkey"), new TableField[] { MetadataContributor.METADATA_CONTRIBUTOR.METADATA_ID }, Keys.DATASET_PKEY, new TableField[] { Dataset.DATASET.DID }, true);
    public static final ForeignKey<MetadataFunderRecord, DatasetRecord> METADATA_FUNDER__METADATA_FUNDER_METADATA_ID_FKEY = Internal.createForeignKey(MetadataFunder.METADATA_FUNDER, DSL.name("metadata_funder_metadata_id_fkey"), new TableField[] { MetadataFunder.METADATA_FUNDER.METADATA_ID }, Keys.DATASET_PKEY, new TableField[] { Dataset.DATASET.DID }, true);
    public static final ForeignKey<MetadataSpecimenRecord, DatasetRecord> METADATA_SPECIMEN__METADATA_SPECIMEN_METADATA_ID_FKEY = Internal.createForeignKey(MetadataSpecimen.METADATA_SPECIMEN, DSL.name("metadata_specimen_metadata_id_fkey"), new TableField[] { MetadataSpecimen.METADATA_SPECIMEN.METADATA_ID }, Keys.DATASET_PKEY, new TableField[] { Dataset.DATASET.DID }, true);
